...
| [[Réglages\|Reglages]] | Appairage, capteurs, accessibilité |

## Ce qui distingue ce projet

**Trois transports, choisis automatiquement** — câble USB (1–2 ms), Wi-Fi
(2–5 ms), Bluetooth en secours. Voir [[Transports]].

**Le clavier respecte votre disposition** — ⌘A reste « tout sélectionner »
même sur un Mac AZERTY, là où une table figée enverrait ⌘Q et quitterait
l'app. Voir [[Clavier]].

**Rien ne passe sans appairage** — se connecter au réseau ne donne aucun
droit. Voir [[Sécurité\|Securite]].

**Aucun compte payant** — un identifiant Apple gratuit suffit, avec une
contrainte à connaître : [[la limite des 7 jours\|Installation]].
